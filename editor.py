...
class ImprovedEditor:
    def __init__(self, document):
        self.dictionary = set()
        with open("C:\Users\machy\AppData\Roaming\Microsoft\Spelling\en-US\default.dic") as input_dictionary:
...
for n in range({}):
    ...
    def benchmark(self):
        print("Improved Benchmark Performance Results")
        for case in self.cases:
            print("Evaluation case: {}".format(case))
...
if __name__ == "__main__":
    b = ImprovedEditorBenchmarker(["Hello friends"], 100)
    b.benchmark()
